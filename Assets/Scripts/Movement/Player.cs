namespace GorillaLocomotion
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        {
            // Kind of like a souped-up spherecast. Includes checks to make sure that the sphere we're using, if it touches a surface, is pushed away the correct distance (the original sphereradius distance). Since you might be pushing into sharp corners, this might not always be valid, so that's what the extra checks are for
